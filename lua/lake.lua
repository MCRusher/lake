...
lake.version = "1.0" --generally you could just check if a function is nil before using it though
...
function lake.guessOS(guess)
	local answer
	if jit then answer = jit.os --leverage luajit's builtin os flag instead of making a wild guess
